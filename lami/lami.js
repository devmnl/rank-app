...
const employeesMachine1 = [
    { name: 'FRANCISCO', image: '/images/default-user.png', color: 'rgba(255, 99, 132, 0.6)' },
    { name: 'TIETA', image: '/images/default-user.png', color: 'rgba(54, 162, 235, 0.6)' },
    { name: '???', image: '/images/default-user.png', color: 'rgba(255, 159, 64, 0.6)' },
    { name: '???', image: '/images/default-user.png', color: 'rgba(153, 102, 255, 0.6)' }
];

const employeesMachine2 = [
    { name: 'DAVID', image: '/images/default-user.png', color: 'rgba(153, 102, 255, 0.6)' },
    { name: 'CESAR', image: '/images/default-user.png', color: 'rgba(255, 99, 132, 0.6)' },
    { name: '???', image: '/images/default-user.png', color: 'rgba(54, 162, 235, 0.6)' },
    { name: '???', image: '/images/default-user.png', color: 'rgba(255, 159, 64, 0.6)' }
];
